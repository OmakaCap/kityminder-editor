(function () {
    var oldData;
    var html = '';
    html += '<a href="" class="diy publish">发布</a>';
    html += '<a href="" class="diy export" data-type="json">导出json</a>';
    html += '<a href="" class="diy upload">上传至仓库</a>';
    ...
    html += '<button class=\"diy input\">导入历史版本<input type=\"file\" id=\"fileInput\" accept=\".km,.txt,.md,.json\"></button>';
    ...
    $(document).on('click', '.export', function (event) {
        ...
        editor.minder.exportData(exportType);
